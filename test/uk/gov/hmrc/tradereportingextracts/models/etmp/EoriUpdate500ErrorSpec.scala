...
class EoriUpdate500ErrorSpec extends AnyFreeSpec with Matchers {
  ...
  "EoriUpdate500Error" - {
    ...
    "must serialize and deserialize correctly with SourceFaultDetail" in {
      ...
      val error             = EoriUpdate500Error(errorDetail)
      ...
      json.as[EoriUpdate500Error] mustBe error
    }
  }
}
